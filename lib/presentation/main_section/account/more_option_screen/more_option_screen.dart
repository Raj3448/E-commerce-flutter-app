...
class MoreOptionScreen extends StatelessWidget {
                ...
                return GestureDetector(
                  onTap: () {
                    if (index == 2) {
                      ...
                      showAlertDialog(context, "Write To Us",
                          "Raise A Complaint", "Track Complaint Status");
                    } else if (index == 0) {
                    ...
                    child: Flex(
                      ...
                      children: [
                        Expanded(
                            flex: 1,
                            child: Image.asset(
                                'assets/images/more${index + 1}.png')),
                        Expanded(
                          flex: 4,
                          child: Text(
                            titles[index],
        ...
        child: Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                color: chatColor, borderRadius: BorderRadius.circular(12)),
            child: Row(
  ...
  showAlertDialog(BuildContext context, String titleText, String contentLine1,
      String contentLine2) {
