...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  @override
  void initState() {
    reaction((_) => store.addCartfailure, (addCartfailure) {
      if (addCartfailure != null && mounted) {
        ScaffoldMessenger.of(context)
          ..hideCurrentSnackBar()
          ..showSnackBar(
            SnackBar(content: Text(addCartfailure)),
          );
      }
      store.addCartfailure = null;
    });
    reaction((_) => store.addCartSuccess, (addCartSuccess) {
      if (addCartSuccess) {
        Get.to(() => CartScreen());
      }
      store.addCartSuccess = false;
    });
    super.initState();
  }
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Spacer(),
                                Text(
                                  'Available color: ${widget.productDetails.color.length}',
                                  style: GoogleFonts.poppins(
                                      fontSize: 15.px,
                                      fontWeight: FontWeight.w400,
                                      color: Colors.black54),
                                ...
                                child: GridView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return InkWell(
                                      ...
                                      child:
                                          SimilarPopularBrandWidget(index: index),
                                    );
                                  },
                                )),
                            sizedBoxHeight20,
                ...
                children: [
                  Container(
                    ...
                    store.addCart(
                        ...
                        size: widget.productDetails.size.first,
                        quantity: 1);
                  }),
                  Container(
                    height: Adaptive.h(6),
